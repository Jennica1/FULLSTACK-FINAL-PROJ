  ...
  return (
    <div>
      ...
      <div style={styles.container}>
        ...
        <p>
          <strong>Date:</strong> March 24th, 2025
        </p>
        <p>
          <strong>Time:</strong> 5pm - 8pm
        </p>
        <p>
          <strong>Location:</strong> JW Marriott Parq Hotel
        </p>
        <p style={styles.paragraph}>
          The Vancouver Career Fair is a premier networking event connecting job
          seekers with top employers. Whether you’re a student, recent graduate,
          or professional looking for a career change, this fair provides an
          opportunity to discover job openings, gain insights, and make valuable
          connections.
        </p>
