...
const pool = new Pool({
  user: process.env.DB_USER || posgres,          // PostgreSQL username
  host: process.env.DB_HOST || localhost,          // Database host (e.g., localhost or IP address)
  database: process.env.DB_NAME || rsvps,      // Your database name (e.g., rsvp_db)
